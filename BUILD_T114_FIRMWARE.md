...
- `t114_signal_tester/linker/nrf52840_s140_v6_survey.ld`: protects the 640 KB internal-flash log partition from application code.
...
```text
artifacts\t114-signal-tester\heltec-t114-signal-mobile.uf2
artifacts\t114-signal-tester\heltec-t114-signal-base.uf2
```
